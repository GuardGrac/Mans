...
<body>
    ...
    <header class="mt-[10vh]">
        ...
        <footer class="flex w-screen justify-center spacing-between-sec items-center mx-auto mt-[10vh]">
            <div class="flex flex-col w-screen items-center leading-[2rem] font-['Mulish']">
                <span class="batch mx-5 2xl:text-[86px] text-5xl text-center relative line1 italiana py-5">
                ALPHA
                </span>
                <p class="batch text-[22px] text-center">
                    Превращаем ткань в одежду
                </p>
                <div class="flex flex-row justify-evenly items-center w-[100px] 2xl:pt-[10vh] pt-[5vh]">
                    <svg class="batch" viewBox="0 0 35 18" fill="black" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex 2xl:flex-row flex-col w-[92%] items-center text-center text-lg 2xl:pt-[10vh] pt-[5vh] justify-between">
                    <span class="batch 2xl:py-0 py-[1vh]">
                        © Alpha Attire Co. Все права защищены️
                    </span>
                    <span class="batch 2xl:pr-20 text-lg underline 2xl:py-0 py-[1vh]">
                        Политика конфиденциальности
                    </span>
                    <span class="batch text-lg 2xl:mr-10 2xl:py-0 py-[1vh]">
        ...
        <div id="menu" class="">
            ...
            <nav class="main-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a href="index.php" class="batch logo_text links_burger" link="#000000" vlink="000000">
                            Alpha
                        </a>
                    </li>

                    <li>
                        <a href="catalog.php" class="batch links links_burger" link="#000000" vlink="000000">
                            Каталог
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/login-signup-form/registration.php" class="batch links links_burger" link="#000000" vlink="000000">
                            Регистрация
                        </a>
                    </li>

                    <li>
                        <a href="/login-signup-form/login.php" class="batch links links_burger" link="#000000" vlink="000000">
                            Вход
                        </a>
                    </li>

                    <li>
                        <a href="/profile.php" class="batch links links_burger" link="#000000" vlink="000000">
                            Профиль
                        </a>
                    </li>
    ...
    <script src="/js/profile-loader.js?no-cache"></script>
