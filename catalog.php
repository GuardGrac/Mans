...
<nav class="w-screen text-black bg-white/90 z-10 py-1 pt-[2vh] fixed 2xl:mx-auto xl:px-0 xl:mx-auto px-[8vw] 2xl:px-[4vw] nav_links">
    ...
    <main class="main-section">
        ...
        <form id="search-form" class="relative">
            <!-- Строка поиска -->
            <label>
                <input id="search" type="text" spellcheck="false" autocomplete="off" placeholder="Catalog item name"> 
                <button id="reset" type="reset" title="Click me to clear the input field">&#215;</button>
            </label>
            
            <!-- Вывод товаров -->
            <output class="absolute top-[30px] left-0 bg-white w-[20%]">
    ...
    <script src="/js/main.js?no-cache"></script>
